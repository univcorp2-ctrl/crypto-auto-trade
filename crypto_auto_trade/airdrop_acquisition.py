...
VERIFIED_GATED_ACTIONS: dict[str, dict[str, Any]] = {
    ...
    "ethereal-trading": {
        "verified_at": "2026-08-12T11:27:29+00:00",
        "evidence_source": "https://docs.ethereal.trade/points/ethereal-points",
        "evidence_note": "Current official Ethereal Rewards & Points states that all authentic trading activity on Ethereal earns Ethereal Points. Official Trading API documentation exposes supported mainnet order submission, and mutating TradeOrder calls require EIP-712 authentication. Together these primary sources support treating genuine API-originated trades as authentic exchange trading activity for acquisition gating; live execution remains unapproved.",
        "acquisition_state": "APPROVAL_REQUIRED_FINANCIAL",
        "requires_funds": True,
        ...
        "requires_asset_move": True,
        "authentication_recheck_required": True,
        "terms_status": "REVERIFY_CURRENT_TERMS_JURISDICTION_ACCOUNT_AND_API_AUTHENTICATION",
        "known_cost_or_risk": "Qualification requires authentic perpetual trading. Real orders create fees, spread/slippage, funding, margin, liquidation and directional PnL risk; API order submission requires cryptographic authentication and a funded subaccount. Reward weights can change and no fixed reward-per-dollar is guaranteed.",
        "missing_approval": "Current Terms/jurisdiction and account eligibility plus funded-subaccount status, API signer/authentication method, explicit market, maximum notional, fee budget, leverage and maximum loss.",
        "next_action": "Verify current Terms/jurisdiction, account eligibility, funded-subaccount state and API signer setup, then prepare a capped authentic API-trading plan for explicit approval; do not deposit, sign or submit real orders automatically.",
    },
    "ethereal-margin": {
        "verified_at": "2026-08-12T05:25:00+00:00",
        "evidence_source": "https://docs.ethereal.trade/points/ethereal-points",
